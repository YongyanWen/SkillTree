...
ll_policy_params = AttrDict(
    ...
    policy_model_checkpoint=os.path.join(os.environ["EXP_DIR"],
                                         "skill_prior_learning/calvin/hierarchical_cl_vq_cdt/K_8"),
)
...
hl_policy_params.update(AttrDict(
    policy=CARTPolicy,
    policy_model_checkpoint=os.path.join(os.environ["EXP_DIR"],
                                         "hrl/calvin/cdt_cl_vq_prior_cdt_eval/cart_fine_1000_d6.pkl"),
    codebook_checkpoint=os.path.join(os.environ["EXP_DIR"],
                                     "hrl/calvin/cdt_cl_vq_prior_cdt/s0/weights/weights_ep24.pth"),
